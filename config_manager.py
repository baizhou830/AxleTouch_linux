...
def load_interactions():
    ...
    if not os.path.exists(INTERACTIONS_PATH):
        save_interactions(DEFAULT_INTERACTIONS)
        return [dict(i) for i in DEFAULT_INTERACTIONS]
    try:
        ...
        shutil.copy(INTERACTIONS_PATH, INTERACTIONS_PATH + ".bak")
        save_interactions(DEFAULT_INTERACTIONS)
        return [dict(i) for i in DEFAULT_INTERACTIONS]
